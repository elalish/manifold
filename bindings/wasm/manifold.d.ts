...
export declare type ErrorStatus = 'NoError' | 'NonFiniteVertex' |
    'NotManifold' | 'VertexOutOfBounds' | 'PropertiesWrongLength' |
    'MissingPositionProperties' | 'MergeVectorsDifferentLengths' |
    'MergeIndexOutOfBounds' | 'TransformWrongLength' | 'RunIndexWrongLength' |
    'FaceIDWrongLength' | 'InvalidConstruction'
 ...
 * @hidden
 */
export declare interface SealedFloat32Array<N extends number> extends
    Float32Array {
  length: N;
}
 ...
 * @hidden
 */
export declare interface SealedUint32Array<N extends number> extends
    Uint32Array {
  length: N;
}
