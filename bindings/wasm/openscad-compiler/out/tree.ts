...
function simple_tree$mod(size: any, dna: any, n: any): any {
...
(() => {
  const __items = [];
  {
    const __iter_0: any = dna;
    for (const bd of __iter_0) {
      __items.push(((angx: any) => (((angz: any) => (((scal: any) => (__with_children(() => Manifold.union([]), 0, () => simple_tree$mod(__mul(scal, size), dna, __sub(n, 1))).rotate([angx, 0, angz])))(bd[2])))(bd[1])))(bd[0]));
    }
  }
...
var dna: any = [[12, 80, 0.85], [55, 0, 0.6], [62, 125, 0.6], [57, __neg(125), 0.6]];
...
__result_items.push(__with_children(() => Manifold.union([]), 0, () => simple_tree$mod(50, dna, 5)));
