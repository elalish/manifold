...
__result_items.push(__difference2d3d(((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))([size, size, size]), [
  Manifold.cylinder(__add(size, 1), hole_r, hole_r, 64, true)
]));
