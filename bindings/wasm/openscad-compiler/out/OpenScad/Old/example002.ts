...
function example002$mod(): any {
  ...
  __difference2d3d(__union2d3d([
  ((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))([30, 30, 30]),
  ((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))([15, 15, 50]).translate([0, 0, __neg(25)])
]), [
  __union2d3d([
  ...
  Manifold.cylinder(50, 20, 5, 0, true).translate([0, 0, 5])
]));
...
__result_items.push(__with_children(() => Manifold.union([]), 0, () => example002$mod()));
