...
var $fs: any = 1;
var $fa: any = 3;
var bodywidth: any = dxf_dim_fn(/* file = */ "example009.dxf", /* name = */ "bodywidth");
var fanwidth: any = dxf_dim_fn(/* file = */ "example009.dxf", /* name = */ "fanwidth");
var platewidth: any = dxf_dim_fn(/* file = */ "example009.dxf", /* name = */ "platewidth");
var fan_side_center: any = dxf_cross_fn(/* file = */ "example009.dxf", /* layer = */ "fan_side_center");
var fanrot: any = dxf_dim_fn(/* file = */ "example009.dxf", /* name = */ "fanrot");
...
__result_items.push(Manifold.union([]));
__result_items.push(__intersection2d3d([
  Manifold.union([]),
  Manifold.union([])
]));
