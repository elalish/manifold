...
function example004$mod(): any {
  ...
  const __items: any[] = [];
  __items.push(__difference2d3d(((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))(30), [
  Manifold.sphere(20)
]));
...
__result_items.push(__with_children(() => Manifold.union([]), 0, () => example004$mod()));
