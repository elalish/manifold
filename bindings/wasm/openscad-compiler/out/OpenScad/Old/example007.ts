...
function cutout$mod(): any {
  ...
  Manifold.union([]).translate([0, 0, __neg(50)]).rotate(90),
  Manifold.union([]).translate([0, 0, __neg(50)]).rotate(90).rotate(90)
]));
  return __union2d3d(__items);
}
function clip$mod(): any {
  var __c: any = __children_stack.length > 0 ? __children_stack[__children_stack.length - 1] : { fn: undefined, count: 0 };
  var $children: any = __c.count;
  function children(i: any): any { return __c.fn ? __c.fn(i) : Manifold.union([]); }
  const __items: any[] = [];
  __items.push(__difference2d3d(Manifold.union([]), [
  (() => {
  const __items = [];
  {
    const __iter_0: any = [0, 90];
    for (const r of __iter_0) {
      __items.push(__with_children(() => Manifold.union([]), 0, () => cutout$mod()).rotate(r));
    }
  }
  return __union2d3d(__items);
})()
...
function cutview$mod(): any {
  var __c: any = __children_stack.length > 0 ? __children_stack[__children_stack.length - 1] : { fn: undefined, count: 0 };
  var $children: any = __c.count;
  function children(i: any): any { return __c.fn ? __c.fn(i) : Manifold.union([]); }
  const __items: any[] = [];
  __items.push(__difference2d3d(__difference2d3d(__with_children(() => Manifold.union([]), 0, () => clip$mod()).translate([0, 0, __neg(10)]), [
  ((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))(30).translate([18, 0, 0]).rotate(__neg(20)).rotate(20)
]), [
  /* render(5) */ __intersection2d3d([
  __with_children(() => Manifold.union([]), 0, () => clip$mod()).translate([0, 0, __neg(10)]),
  ((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))(30).translate([18, 0, 0]).rotate(__neg(20)).rotate(20)
])
]));
  return __union2d3d(__items);
...
__result_items.push(__with_children(() => Manifold.union([]), 0, () => clip$mod()).translate([0, 0, __neg(10)]));
