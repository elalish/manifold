...
function shape$mod(): any {
  ...
  const __items: any[] = [];
  __items.push(__difference2d3d(__intersection2d3d([
  __union2d3d([
  __difference2d3d(((__s: any) => CrossSection.square((is_list_fn(__s) ? __s : [__s, __s]), true))(100), [
  ((__s: any) => CrossSection.square((is_list_fn(__s) ? __s : [__s, __s]), true))(50)
]),
  ((__s: any) => CrossSection.square((is_list_fn(__s) ? __s : [__s, __s]), true))(15).translate([50, 50])
]),
  ((__s: any) => CrossSection.square((is_list_fn(__s) ? __s : [__s, __s]), false))([100, 30]).translate([0, __neg(15)]).rotate(45)
]).translate([__neg(35), __neg(35)]), [
  CrossSection.circle(5).scale([0.7, 1.3]).rotate(__neg(45))
]));
  __items.push(Manifold.union([]));
...
__result_items.push(__with_children(() => Manifold.union([]), 0, () => shape$mod()));
