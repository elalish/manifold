...
function blk1$mod(): any {
  ...
  const __items: any[] = [];
  __items.push(((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))([65, 28, 28]));
  return __union2d3d(__items);
}
function blk2$mod(): any {
  var __c: any = __children_stack.length > 0 ? __children_stack[__children_stack.length - 1] : { fn: undefined, count: 0 };
  var $children: any = __c.count;
  function children(i: any): any { return __c.fn ? __c.fn(i) : Manifold.union([]); }
  const __items: any[] = [];
  __items.push(__difference2d3d(((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))([60, 28, 14]).translate([0, 0, 7.5]), [
  ((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))([8, 32, 32])
]));
  return __union2d3d(__items);
}
function chop$mod(): any {
  var __c: any = __children_stack.length > 0 ? __children_stack[__children_stack.length - 1] : { fn: undefined, count: 0 };
  var $children: any = __c.count;
  function children(i: any): any { return __c.fn ? __c.fn(i) : Manifold.union([]); }
  const __items: any[] = [];
  __items.push(Manifold.union([]).translate([__neg(18), 0, 0]));
  return __union2d3d(__items);
}
...
__result_items.push(__difference2d3d(__with_children(() => Manifold.union([]), 0, () => blk1$mod()), [
  (() => {
  const __items = [];
  {
    const __iter_0: any = [0, 90, 180, 270];
    for (const alpha of __iter_0) {
      __items.push(/* render(12) */ __difference2d3d(__with_children(() => Manifold.union([]), 0, () => blk2$mod()), [
  __with_children(() => Manifold.union([]), 0, () => chop$mod())
]).rotate(alpha));
    }
  }
  return __union2d3d(__items);
