...
__result_items.push(__apply_color(__extrude(((__s: any) => CrossSection.square((is_list_fn(__s) ? __s : [__s, __s]), true))([20, 10]), 20).translate([0, __neg(30), 0]), "red", undefined));
// using the scale parameter a frustum can be constructed
__result_items.push(__apply_color(__extrude(((__s: any) => CrossSection.square((is_list_fn(__s) ? __s : [__s, __s]), true))([20, 10]), 20).translate([__neg(30), 0, 0]), "green", undefined));
// with twist the extruded shape will rotate around the Z axis
__result_items.push(__apply_color(__extrude(((__s: any) => CrossSection.square((is_list_fn(__s) ? __s : [__s, __s]), true))([20, 10]), 20, { twist: 90 }).translate([30, 0, 0]), "cyan", undefined));
// combining both relatively complex shapes can be created
__result_items.push(__apply_color(__extrude(((__s: any) => CrossSection.square((is_list_fn(__s) ? __s : [__s, __s]), true))([20, 10]), 40, { twist: __neg(360) }).translate([0, 30, 0]), "gray", undefined));
