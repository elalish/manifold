...
// a 2D shape.
__result_items.push(__apply_color(__extrude(__difference2d3d(((__s: any) => CrossSection.square((is_list_fn(__s) ? __s : [__s, __s]), true))(30), [
  CrossSection.square(0)
]), 2).translate([0, 0, __neg(20)]), "red", undefined));
__result_items.push(__apply_color(__extrude(__difference2d3d(((__s: any) => CrossSection.square((is_list_fn(__s) ? __s : [__s, __s]), true))(30), [
  __safe_project3d(Manifold.union([]).rotate([0, 90, 0]))
]), 2).translate([0, 0, __neg(20)]).rotate([0, 90, 0]), "green", undefined));
__result_items.push(__apply_color(__extrude(__difference2d3d(((__s: any) => CrossSection.square((is_list_fn(__s) ? __s : [__s, __s]), true))(30), [
  __safe_project3d(Manifold.union([]).rotate([90, 0, 0]))
]), 2).translate([0, 0, 20]).rotate([__neg(90), 0, 0]), "cyan", undefined));
