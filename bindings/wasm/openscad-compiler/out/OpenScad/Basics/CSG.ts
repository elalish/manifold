...
__result_items.push(__union2d3d([
  ((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))(15),
  Manifold.sphere(10)
]).translate([__neg(24), 0, 0]));
__result_items.push(__intersection2d3d([
  ((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))(15),
  Manifold.sphere(10)
]));
__result_items.push(__difference2d3d(((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))(15), [
  Manifold.sphere(10)
]).translate([24, 0, 0]));
