...
__result_items.push(__hull2d3d([
  Manifold.sphere(1).translate([0, 30, 2.5]),
  ((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))([20, 1, 8]).translate([0, 10, __neg(1)]),
  ((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))([1, 1, 8]).translate([0, 10, __neg(5)]),
  ((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))([20, 1, 8]).translate([0, __neg(8), __neg(1)]),
  ((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))([1, 1, 8]).translate([0, __neg(8), __neg(5)]),
  ((__s: any) => Manifold.cube((is_list_fn(__s) ? __s : [__s, __s, __s]), true))([16, 1, 4]).translate([0, __neg(30), 1])
]));
__result_items.push(Manifold.cylinder(40, 1, 1)); //Mast
