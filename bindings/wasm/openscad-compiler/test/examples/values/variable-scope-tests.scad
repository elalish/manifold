...
// user-defined special variables as parameter
...
// undeclared variable can still be passed and used
module undeclared_var() {
  echo(d);
}
undeclared_var(d=6);

// attempt to assign from a not-yet-defined variable which also exists globally
