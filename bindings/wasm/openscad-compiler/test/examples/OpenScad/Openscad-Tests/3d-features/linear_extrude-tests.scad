// Volume: 14297.54658734711, SurfaceArea: 9903.400626109558
// Empty
linear_extrude();
// No children
linear_extrude() { }
...
translate([-19,21,0]) linear_extrude(height=20, twist=30, slices=2, segments=0) {
    difference() {
...
translate([-35,20,0]) linear_extrude(height=20, scale=[4,5,6]) square(10);
// scale is negative
