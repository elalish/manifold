...
// assuming manifold emscripten build is in ../release, run this:
// emcc -fexceptions -lembind -o manifold.js bindings.cpp -I ../manifold/include/ -I ../utilities/include/ -I ../third_party/glm/ -Wl,--whole-archive ../release/collider/libcollider.a ../release/manifold/libmanifold.a ../release/polygon/libpolygon.a ../release/third_party/graphlite/libgraphlite.a -Wl,--no-whole-archive