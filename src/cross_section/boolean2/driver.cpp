...
// Unlike MergeVerts, this pass only merges vertices generated by intersection
// insertion: new-new points from independent edge pairs within a small eps
// multiple, plus new-to-old snaps within the propagated operation tolerance. It
// intentionally does not widen old-old merges, which would stack tolerance
// drift across repeated CrossSection operations.
