 ...
 * @group Global Settings
 */
export declare const getCircularSegments: (radius: number) => number;
 ...
 */
export declare const getGLTFNodes: () => BaseGLTFNode[];
...
export declare class VisualizationGLTFNode extends BaseGLTFNode {
    ...
    uri?: string;
    constructor(document: GLTFTransform.Document, node?: GLTFTransform.Node, parent?: BaseGLTFNode);
