(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();const $c="modulepreload",qc=function(i){return"/"+i},go={},Yc=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let c=function(l){return Promise.all(l.map(d=>Promise.resolve(d).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),o=a?.nonce||a?.getAttribute("nonce");r=c(t.map(l=>{if(l=qc(l),l in go)return;go[l]=!0;const d=l.endsWith(".css"),p=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${p}`))return;const m=document.createElement("link");if(m.rel=d?"stylesheet":$c,d||(m.as="script"),m.crossOrigin="",m.href=l,o&&m.setAttribute("nonce",o),document.head.appendChild(m),d)return new Promise((v,S)=>{m.addEventListener("load",v),m.addEventListener("error",()=>S(new Error(`Unable to preload CSS for ${l}`)))})}))}function s(a){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=a,window.dispatchEvent(o),!o.defaultPrevented)throw a}return r.then(a=>{for(const o of a||[])o.status==="rejected"&&s(o.reason);return e().catch(s)})};async function jc(i={}){var e,t=i,n=!!globalThis.window,r=!!globalThis.WorkerGlobalScope,s=globalThis.process?.versions?.node&&globalThis.process?.type!="renderer";if(s){const{createRequire:u}=await Yc(()=>import("./__vite-browser-external.js"),[]);var a=u(import.meta.url)}var o=!1;t.setup=function(){if(o)return;o=!0,t.initTBB();function u(U,H,re=(fe=>fe)){if(H)for(let fe of H)U.push_back(re(fe));return U}function f(U,H=(re=>re)){const re=[],fe=U.size();for(let ke=0;ke<fe;ke++)re.push(H(U.get(ke)));return re}function y(U,H=(re=>re)){const re=[],fe=U.size();for(let ke=0;ke<fe;ke++){const gt=U.get(ke),Rt=gt.size(),Kt=[];for(let Bt=0;Bt<Rt;Bt++)Kt.push(H(gt.get(Bt)));re.push(Kt)}return re}function D(U){return U[0].length<3&&(U=[U]),u(new t.Vector2_vec2,U,H=>u(new t.Vector_vec2,H,re=>re instanceof Array?{x:re[0],y:re[1]}:re))}function z(U){for(let H=0;H<U.size();H++)U.get(H).delete();U.delete()}function $(U){return U[0]instanceof Array?{x:U[0][0],y:U[0][1]}:typeof U[0]=="number"?{x:U[0]||0,y:U[1]||0}:U[0]}function Q(U){return U[0]instanceof Array?{x:U[0][0],y:U[0][1],z:U[0][2]}:typeof U[0]=="number"?{x:U[0]||0,y:U[1]||0,z:U[2]||0}:U[0]}function se(U){return U=="EvenOdd"?0:U=="NonZero"?1:U=="Negative"?3:2}function pe(U){return U=="Round"?1:U=="Miter"?2:0}const Re=t.CrossSection;function Oe(U,H="Positive"){if(U instanceof Re)return U;{const re=D(U),fe=new Re(re,se(H));return z(re),fe}}t.CrossSection.prototype.translate=function(...U){return this._Translate($(U))},t.CrossSection.prototype.scale=function(U){return typeof U=="number"?this._Scale({x:U,y:U}):this._Scale($([U]))},t.CrossSection.prototype.mirror=function(U){return this._Mirror($([U]))},t.CrossSection.prototype.warp=function(U){const H=Si(function(fe){const ke=Xe(fe,"double"),gt=Xe(fe+8,"double"),Rt=[ke,gt];U(Rt),tt(fe,Rt[0],"double"),tt(fe+8,Rt[1],"double")},"vi"),re=this._Warp(H);return Ei(H),re},t.CrossSection.prototype.decompose=function(){const U=this._Decompose(),H=f(U);return U.delete(),H},t.CrossSection.prototype.bounds=function(){const U=this._Bounds();return{min:["x","y"].map(H=>U.min[H]),max:["x","y"].map(H=>U.max[H])}},t.CrossSection.prototype.offset=function(U,H="Round",re=2,fe=0){return this._Offset(U,pe(H),re,fe)},t.CrossSection.prototype.simplify=function(U=1e-6){return this._Simplify(U)},t.CrossSection.prototype.extrude=function(U,H=0,re=0,fe=[1,1],ke=!1){fe=$([fe]);const gt=t._Extrude(this._ToPolygons(),U,H,re,fe);return ke?gt.translate([0,0,-U/2]):gt},t.CrossSection.prototype.revolve=function(U=0,H=360){return t._Revolve(this._ToPolygons(),U,H)},t.CrossSection.prototype.add=function(U){return this._add(Oe(U))},t.CrossSection.prototype.subtract=function(U){return this._subtract(Oe(U))},t.CrossSection.prototype.intersect=function(U){return this._intersect(Oe(U))},t.CrossSection.prototype.toPolygons=function(){const U=this._ToPolygons(),H=y(U,re=>[re.x,re.y]);return U.delete(),H},t.Manifold.prototype.smoothOut=function(U=60,H=0){return this._SmoothOut(U,H)},t.Manifold.prototype.warp=function(U){const H=Si(function(ke){const gt=Xe(ke,"double"),Rt=Xe(ke+8,"double"),Kt=Xe(ke+16,"double"),Bt=[gt,Rt,Kt];U(Bt),tt(ke,Bt[0],"double"),tt(ke+8,Bt[1],"double"),tt(ke+16,Bt[2],"double")},"vi"),re=this._Warp(H);Ei(H);const fe=re.status();if(fe!=="NoError")throw new t.ManifoldError(fe);return re},t.Manifold.prototype.warpBatch=function(U){const H=Si(function(ke,gt){const Rt=t.HEAPF64??N;if(!Rt)throw new Error("WASM heap is not initialized (HEAPF64 unavailable)");const Kt=new Float64Array(Rt.buffer,ke,gt*3);U(Kt,gt)},"vii"),re=this._WarpBatch(H);Ei(H);const fe=re.status();if(fe!=="NoError")throw new t.ManifoldError(fe);return re},t.Manifold.prototype.calculateNormals=function(U,H=60){return this._CalculateNormals(U,H)},t.Manifold.prototype.setProperties=function(U,H){const re=this.numProp(),fe=Si(function(gt,Rt,Kt){const Bt=[];for(let Ct=0;Ct<U;++Ct)Bt[Ct]=Xe(gt+8*Ct,"double");const yi=[];for(let Ct=0;Ct<3;++Ct)yi[Ct]=Xe(Rt+8*Ct,"double");const bi=[];for(let Ct=0;Ct<re;++Ct)bi[Ct]=Xe(Kt+8*Ct,"double");H(Bt,yi,bi);for(let Ct=0;Ct<U;++Ct)tt(gt+8*Ct,Bt[Ct],"double")},"viii"),ke=this._SetProperties(U,fe);return Ei(fe),ke},t.Manifold.prototype.translate=function(...U){return this._Translate(Q(U))},t.Manifold.prototype.rotate=function(U,H,re){return Array.isArray(U)?this._Rotate(...U):this._Rotate(U,H||0,re||0)},t.Manifold.prototype.scale=function(U){return typeof U=="number"?this._Scale({x:U,y:U,z:U}):this._Scale(Q([U]))},t.Manifold.prototype.mirror=function(U){return this._Mirror(Q([U]))},t.Manifold.prototype.trimByPlane=function(U,H=0){return this._TrimByPlane(Q([U]),H)},t.Manifold.prototype.slice=function(U=0){const H=this._Slice(U),re=new Re(H,se("Positive"));return z(H),re},t.Manifold.prototype.project=function(){const U=this._Project(),H=new Re(U,se("Positive"));return z(U),H},t.Manifold.prototype.split=function(U){const H=this._Split(U),re=f(H);return H.delete(),re},t.Manifold.prototype.splitByPlane=function(U,H=0){const re=this._SplitByPlane(Q([U]),H),fe=f(re);return re.delete(),fe},t.Manifold.prototype.decompose=function(){const U=this._Decompose(),H=f(U);return U.delete(),H},t.Manifold.prototype.boundingBox=function(){const U=this._boundingBox();return{min:["x","y","z"].map(H=>U.min[H]),max:["x","y","z"].map(H=>U.max[H])}},t.Manifold.prototype.simplify=function(U=0){return this._Simplify(U)};class it{constructor({numProp:H=3,triVerts:re=new Uint32Array,vertProperties:fe=new Float32Array,mergeFromVert:ke,mergeToVert:gt,runIndex:Rt,runOriginalID:Kt,faceID:Bt,halfedgeTangent:yi,runTransform:bi,tolerance:Ct=0}={}){this.numProp=H,this.triVerts=re,this.vertProperties=fe,this.mergeFromVert=ke,this.mergeToVert=gt,this.runIndex=Rt,this.runOriginalID=Kt,this.faceID=Bt,this.halfedgeTangent=yi,this.runTransform=bi,this.tolerance=Ct}get numTri(){return this.triVerts.length/3}get numVert(){return this.vertProperties.length/this.numProp}get numRun(){return this.runOriginalID.length}merge(){const{changed:H,mesh:re}=t._Merge(this);return Object.assign(this,{...re}),H}verts(H){return this.triVerts.subarray(3*H,3*(H+1))}position(H){return this.vertProperties.subarray(this.numProp*H,this.numProp*H+3)}extras(H){return this.vertProperties.subarray(this.numProp*H+3,this.numProp*(H+1))}tangent(H){return this.halfedgeTangent.subarray(4*H,4*(H+1))}transform(H){const re=new Array(16);for(const fe of[0,1,2,3])for(const ke of[0,1,2])re[4*fe+ke]=this.runTransform[12*H+3*fe+ke];return re[15]=1,re}}t.Mesh=it,t.Manifold.prototype.getMesh=function(U=-1){return new it(this._GetMeshJS(U))},t.ManifoldError=function(H,...re){let fe="Unknown error";switch(H){case"NonFiniteVertex":fe="Non-finite vertex";break;case"NotManifold":fe="Not manifold";break;case"VertexOutOfBounds":fe="Vertex index out of bounds";break;case"PropertiesWrongLength":fe="Properties have wrong length";break;case"MissingPositionProperties":fe="Less than three properties";break;case"MergeVectorsDifferentLengths":fe="Merge vectors have different lengths";break;case"MergeIndexOutOfBounds":fe="Merge index out of bounds";break;case"TransformWrongLength":fe="Transform vector has wrong length";break;case"RunIndexWrongLength":fe="Run index vector has wrong length";break;case"FaceIDWrongLength":fe="Face ID vector has wrong length";case"InvalidConstruction":fe="Manifold constructed with invalid parameters"}const ke=Error.apply(this,[fe,...re]);ke.name=this.name="ManifoldError",this.message=ke.message,this.stack=ke.stack,this.code=H},t.ManifoldError.prototype=Object.create(Error.prototype,{constructor:{value:t.ManifoldError,writable:!0,configurable:!0}}),t.CrossSection=function(U,H="Positive"){const re=D(U),fe=new Re(re,se(H));return z(re),fe},t.CrossSection.ofPolygons=function(U,H="Positive"){return new t.CrossSection(U,H)},t.CrossSection.square=function(...U){let H;U.length==0?H={x:1,y:1}:typeof U[0]=="number"?H={x:U[0],y:U[0]}:H=$(U);const re=U[1]||!1;return t._Square(H,re)},t.CrossSection.circle=function(U,H=0){return t._Circle(U,H)};function ct(U){return function(...H){H.length==1&&(H=H[0]);const re=new t.Vector_crossSection;for(const ke of H)re.push_back(Oe(ke));const fe=t["_crossSection"+U](re);return re.delete(),fe}}t.CrossSection.compose=ct("Compose"),t.CrossSection.union=ct("UnionN"),t.CrossSection.difference=ct("DifferenceN"),t.CrossSection.intersection=ct("IntersectionN");function rt(U,H){u(U,H,re=>re instanceof Array?{x:re[0],y:re[1]}:re)}t.CrossSection.hull=function(...U){U.length==1&&(U=U[0]);let H=new t.Vector_vec2;for(const fe of U)if(fe instanceof Re)t._crossSectionCollectVertices(H,fe);else if(fe instanceof Array&&fe.length==2&&typeof fe[0]=="number")H.push_back({x:fe[0],y:fe[1]});else if(fe.x)H.push_back(fe);else{const gt=fe[0].length==2&&typeof fe[0][0]=="number"||fe[0].x?[fe]:fe;for(const Rt of gt)rt(H,Rt)}const re=t._crossSectionHullPoints(H);return H.delete(),re},t.CrossSection.prototype=Object.create(Re.prototype),Object.defineProperty(t.CrossSection,Symbol.hasInstance,{get:()=>U=>U instanceof Re});const wt=t.Manifold;t.Manifold=function(U){const H=new wt(U),re=H.status();if(re!=="NoError")throw new t.ManifoldError(re);return H},t.Manifold.ofMesh=function(U){return new t.Manifold(U)},t.Manifold.tetrahedron=function(){return t._Tetrahedron()},t.Manifold.cube=function(...U){let H;U.length==0?H={x:1,y:1,z:1}:typeof U[0]=="number"?H={x:U[0],y:U[0],z:U[0]}:H=Q(U);const re=U[1]||!1;return t._Cube(H,re)},t.Manifold.cylinder=function(U,H,re=-1,fe=0,ke=!1){return t._Cylinder(U,H,re,fe,ke)},t.Manifold.sphere=function(U,H=0){return t._Sphere(U,H)},t.Manifold.smooth=function(U,H=[]){const re=new t.Vector_smoothness;u(re,H);const fe=t._Smooth(U,re);return re.delete(),fe},t.Manifold.extrude=function(U,H,re=0,fe=0,ke=[1,1],gt=!1){return(U instanceof Re?U:t.CrossSection(U,"Positive")).extrude(H,re,fe,ke,gt)},t.Manifold.revolve=function(U,H=0,re=360){return(U instanceof Re?U:t.CrossSection(U,"Positive")).revolve(H,re)},t.Manifold.reserveIDs=function(U){return t._ReserveIDs(U)};function Ot(U){return function(...H){H.length==1&&(H=H[0]);const re=new t.Vector_manifold;for(const ke of H)re.push_back(ke);const fe=t["_manifold"+U+"N"](re);return re.delete(),fe}}t.Manifold.union=Ot("Union"),t.Manifold.compose=t.Manifold.union,t.Manifold.difference=Ot("Difference"),t.Manifold.intersection=Ot("Intersection"),t.Manifold.levelSet=function(U,H,re,fe=0,ke=-1){const gt={min:{x:H.min[0],y:H.min[1],z:H.min[2]},max:{x:H.max[0],y:H.max[1],z:H.max[2]}},Rt=Si(function(Bt){const yi=Xe(Bt,"double"),bi=Xe(Bt+8,"double"),Ct=Xe(Bt+16,"double");return U([yi,bi,Ct])},"di"),Kt=t._LevelSet(Rt,gt,re,fe,ke);return Ei(Rt),Kt};function sn(U,H){u(U,H,re=>re instanceof Array?{x:re[0],y:re[1],z:re[2]}:re)}t.Manifold.hull=function(...U){U.length==1&&(U=U[0]);let H=new t.Vector_vec3;for(const fe of U)fe instanceof wt?t._manifoldCollectVertices(H,fe):fe instanceof Array&&fe.length==3&&typeof fe[0]=="number"?H.push_back({x:fe[0],y:fe[1],z:fe[2]}):fe.x?H.push_back(fe):sn(H,fe);const re=t._manifoldHullPoints(H);return H.delete(),re},t.Manifold.prototype=Object.create(wt.prototype),Object.defineProperty(t.Manifold,Symbol.hasInstance,{get:()=>U=>U instanceof wt}),t.triangulate=function(U,H=-1,re=!0){const fe=D(U),ke=f(t._Triangulate(fe,H,re),gt=>[gt[0],gt[1],gt[2]]);return z(fe),ke}};var c=import.meta.url,l="";function d(u){return t.locateFile?t.locateFile(u,l):l+u}var p,m;if(s){var v=a("node:fs");c.startsWith("file:")&&(l=a("node:path").dirname(a("node:url").fileURLToPath(c))+"/"),m=u=>{u=h(u)?new URL(u):u;var f=v.readFileSync(u);return f},p=async(u,f=!0)=>{u=h(u)?new URL(u):u;var y=v.readFileSync(u,f?void 0:"utf8");return y},process.argv.length>1&&process.argv[1].replace(/\\/g,"/"),process.argv.slice(2)}else if(n||r){try{l=new URL(".",c).href}catch{}r&&(m=u=>{var f=new XMLHttpRequest;return f.open("GET",u,!1),f.responseType="arraybuffer",f.send(null),new Uint8Array(f.response)}),p=async u=>{if(h(u))return new Promise((y,D)=>{var z=new XMLHttpRequest;z.open("GET",u,!0),z.responseType="arraybuffer",z.onload=()=>{if(z.status==200||z.status==0&&z.response){y(z.response);return}D(z.status)},z.onerror=D,z.send(null)});var f=await fetch(u,{credentials:"same-origin"});if(f.ok)return f.arrayBuffer();throw new Error(f.status+" : "+f.url)}}console.log.bind(console);var S=console.error.bind(console),b,g=!1,h=u=>u.startsWith("file://"),w,R,T,C,P,L,V,x,E,N,Y,q,ee=!1;function ie(){var u=Ar.buffer;T=new Int8Array(u),P=new Int16Array(u),C=new Uint8Array(u),L=new Uint16Array(u),V=new Int32Array(u),x=new Uint32Array(u),E=new Float32Array(u),N=new Float64Array(u),Y=new BigInt64Array(u),q=new BigUint64Array(u)}function j(){if(t.preRun)for(typeof t.preRun=="function"&&(t.preRun=[t.preRun]);t.preRun.length;)Ut(t.preRun.shift());Pe(nt)}function Z(){ee=!0,ri.J()}function le(){if(t.postRun)for(typeof t.postRun=="function"&&(t.postRun=[t.postRun]);t.postRun.length;)Ie(t.postRun.shift());Pe($e)}function ye(u){t.onAbort?.(u),u="Aborted("+u+")",S(u),g=!0,u+=". Build with -sASSERTIONS for more info.";var f=new WebAssembly.RuntimeError(u);throw R?.(f),f}var xe;function we(){return t.locateFile?d("manifold.wasm"):new URL("/assets/three/manifold.wasm",import.meta.url).href}function Qe(u){if(u==xe&&b)return new Uint8Array(b);if(m)return m(u);throw"both async and sync fetching of the wasm failed"}async function Ke(u){if(!b)try{var f=await p(u);return new Uint8Array(f)}catch{}return Qe(u)}async function bt(u,f){try{var y=await Ke(u),D=await WebAssembly.instantiate(y,f);return D}catch(z){S(`failed to asynchronously prepare wasm: ${z}`),ye(z)}}async function yt(u,f,y){if(!u&&!h(f)&&!s)try{var D=fetch(f,{credentials:"same-origin"}),z=await WebAssembly.instantiateStreaming(D,y);return z}catch($){S(`wasm streaming compile failed: ${$}`),S("falling back to ArrayBuffer instantiation")}return bt(f,y)}function te(){var u={a:kc};return u}async function ce(){function u($,Q){return ri=$.exports,ri=Wc(ri),Hc(ri),ie(),ri}function f($){return u($.instance)}var y=te();if(t.instantiateWasm)return new Promise(($,Q)=>{t.instantiateWasm(y,(se,pe)=>{$(u(se))})});xe??=we();var D=await yt(b,xe,y),z=f(D);return z}var Pe=u=>{for(;u.length>0;)u.shift()(t)},$e=[],Ie=u=>$e.push(u),nt=[],Ut=u=>nt.push(u);function Xe(u,f="i8"){switch(f.endsWith("*")&&(f="*"),f){case"i1":return T[u>>>0];case"i8":return T[u>>>0];case"i16":return P[u>>>1>>>0];case"i32":return V[u>>>2>>>0];case"i64":return Y[u>>>3>>>0];case"float":return E[u>>>2>>>0];case"double":return N[u>>>3>>>0];case"*":return x[u>>>2>>>0];default:ye(`invalid type for getValue: ${f}`)}}function tt(u,f,y="i8"){switch(y.endsWith("*")&&(y="*"),y){case"i1":T[u>>>0]=f;break;case"i8":T[u>>>0]=f;break;case"i16":P[u>>>1>>>0]=f;break;case"i32":V[u>>>2>>>0]=f;break;case"i64":Y[u>>>3>>>0]=BigInt(f);break;case"float":E[u>>>2>>>0]=f;break;case"double":N[u>>>3>>>0]=f;break;case"*":x[u>>>2>>>0]=f;break;default:ye(`invalid type for setValue: ${y}`)}}class vt{constructor(f){this.excPtr=f,this.ptr=f-24}set_type(f){x[this.ptr+4>>>2>>>0]=f}get_type(){return x[this.ptr+4>>>2>>>0]}set_destructor(f){x[this.ptr+8>>>2>>>0]=f}get_destructor(){return x[this.ptr+8>>>2>>>0]}set_caught(f){f=f?1:0,T[this.ptr+12>>>0]=f}get_caught(){return T[this.ptr+12>>>0]!=0}set_rethrown(f){f=f?1:0,T[this.ptr+13>>>0]=f}get_rethrown(){return T[this.ptr+13>>>0]!=0}init(f,y){this.set_adjusted_ptr(0),this.set_type(f),this.set_destructor(y)}set_adjusted_ptr(f){x[this.ptr+16>>>2>>>0]=f}get_adjusted_ptr(){return x[this.ptr+16>>>2>>>0]}}var je=0;function Pt(u,f,y){u>>>=0,f>>>=0,y>>>=0;var D=new vt(u);throw D.init(f,y),je=u,je}var I=()=>ye(""),Tt={},ot=u=>{for(;u.length;){var f=u.pop(),y=u.pop();y(f)}};function ft(u){return this.fromWireType(x[u>>>2>>>0])}var De={},A={},_={},O=class extends Error{constructor(f){super(f),this.name="InternalError"}},J=u=>{throw new O(u)},ne=(u,f,y)=>{u.forEach(se=>_[se]=f);function D(se){var pe=y(se);pe.length!==u.length&&J("Mismatched type converter count");for(var Re=0;Re<u.length;++Re)oe(u[Re],pe[Re])}var z=new Array(f.length),$=[],Q=0;for(let[se,pe]of f.entries())A.hasOwnProperty(pe)?z[se]=A[pe]:($.push(pe),De.hasOwnProperty(pe)||(De[pe]=[]),De[pe].push(()=>{z[se]=A[pe],++Q,Q===$.length&&D(z)}));$.length===0&&D(z)},K=function(u){u>>>=0;var f=Tt[u];delete Tt[u];var y=f.rawConstructor,D=f.rawDestructor,z=f.fields,$=z.map(Q=>Q.getterReturnType).concat(z.map(Q=>Q.setterArgumentType));ne([u],$,Q=>{var se={};for(var[pe,Re]of z.entries()){const Oe=Q[pe],it=Re.getter,ct=Re.getterContext,rt=Q[pe+z.length],wt=Re.setter,Ot=Re.setterContext;se[Re.fieldName]={read:sn=>Oe.fromWireType(it(ct,sn)),write:(sn,U)=>{var H=[];wt(Ot,sn,rt.toWireType(H,U)),ot(H)},optional:Oe.optional}}return[{name:f.name,fromWireType:Oe=>{var it={};for(var ct in se)it[ct]=se[ct].read(Oe);return D(Oe),it},toWireType:(Oe,it)=>{for(var ct in se)if(!(ct in it)&&!se[ct].optional)throw new TypeError(`Missing field: "${ct}"`);var rt=y();for(ct in se)se[ct].write(rt,it[ct]);return Oe!==null&&Oe.push(D,rt),rt},readValueFromPointer:ft,destructorFunction:D}]})},Me=u=>{u>>>=0;for(var f="";;){var y=C[u++>>>0];if(!y)return f;f+=String.fromCharCode(y)}},me=class extends Error{constructor(f){super(f),this.name="BindingError"}},he=u=>{throw new me(u)};function Ge(u,f,y={}){var D=f.name;if(u||he(`type "${D}" must have a positive integer typeid pointer`),A.hasOwnProperty(u)){if(y.ignoreDuplicateRegistrations)return;he(`Cannot register type '${D}' twice`)}if(A[u]=f,delete _[u],De.hasOwnProperty(u)){var z=De[u];delete De[u],z.forEach($=>$())}}function oe(u,f,y={}){return Ge(u,f,y)}var ge=(u,f,y)=>{switch(f){case 1:return y?D=>T[D>>>0]:D=>C[D>>>0];case 2:return y?D=>P[D>>>1>>>0]:D=>L[D>>>1>>>0];case 4:return y?D=>V[D>>>2>>>0]:D=>x[D>>>2>>>0];case 8:return y?D=>Y[D>>>3>>>0]:D=>q[D>>>3>>>0];default:throw new TypeError(`invalid integer width (${f}): ${u}`)}},Ue=function(u,f,y,D,z){u>>>=0,f>>>=0,y>>>=0,f=Me(f);const $=D===0n;let Q=se=>se;if($){const se=y*8;Q=pe=>BigInt.asUintN(se,pe),z=Q(z)}oe(u,{name:f,fromWireType:Q,toWireType:(se,pe)=>(typeof pe=="number"&&(pe=BigInt(pe)),pe),readValueFromPointer:ge(f,y,!$),destructorFunction:null})};function Fe(u,f,y,D){u>>>=0,f>>>=0,f=Me(f),oe(u,{name:f,fromWireType:function(z){return!!z},toWireType:function(z,$){return $?y:D},readValueFromPointer:function(z){return this.fromWireType(C[z>>>0])},destructorFunction:null})}var ve=u=>({count:u.count,deleteScheduled:u.deleteScheduled,preservePointerOnDelete:u.preservePointerOnDelete,ptr:u.ptr,ptrType:u.ptrType,smartPtr:u.smartPtr,smartPtrType:u.smartPtrType}),Ye=u=>{function f(y){return y.$$.ptrType.registeredClass.name}he(f(u)+" instance already deleted")},F=!1,be=u=>{},de=u=>{u.smartPtr?u.smartPtrType.rawDestructor(u.smartPtr):u.ptrType.registeredClass.rawDestructor(u.ptr)},Ae=u=>{u.count.value-=1;var f=u.count.value===0;f&&de(u)},ue=u=>globalThis.FinalizationRegistry?(F=new FinalizationRegistry(f=>{Ae(f.$$)}),ue=f=>{var y=f.$$,D=!!y.smartPtr;if(D){var z={$$:y};F.register(f,z,f)}return f},be=f=>F.unregister(f),ue(u)):(ue=f=>f,u),ae=()=>{let u=_e.prototype;Object.assign(u,{isAliasOf(y){if(!(this instanceof _e)||!(y instanceof _e))return!1;var D=this.$$.ptrType.registeredClass,z=this.$$.ptr;y.$$=y.$$;for(var $=y.$$.ptrType.registeredClass,Q=y.$$.ptr;D.baseClass;)z=D.upcast(z),D=D.baseClass;for(;$.baseClass;)Q=$.upcast(Q),$=$.baseClass;return D===$&&z===Q},clone(){if(this.$$.ptr||Ye(this),this.$$.preservePointerOnDelete)return this.$$.count.value+=1,this;var y=ue(Object.create(Object.getPrototypeOf(this),{$$:{value:ve(this.$$)}}));return y.$$.count.value+=1,y.$$.deleteScheduled=!1,y},delete(){this.$$.ptr||Ye(this),this.$$.deleteScheduled&&!this.$$.preservePointerOnDelete&&he("Object already scheduled for deletion"),be(this),Ae(this.$$),this.$$.preservePointerOnDelete||(this.$$.smartPtr=void 0,this.$$.ptr=void 0)},isDeleted(){return!this.$$.ptr},deleteLater(){return this.$$.ptr||Ye(this),this.$$.deleteScheduled&&!this.$$.preservePointerOnDelete&&he("Object already scheduled for deletion"),this.$$.deleteScheduled=!0,this}});const f=Symbol.dispose;f&&(u[f]=u.delete)};function _e(){}var He=(u,f)=>Object.defineProperty(f,"name",{value:u}),xt={},ht=(u,f,y)=>{if(u[f].overloadTable===void 0){var D=u[f];u[f]=function(...z){return u[f].overloadTable.hasOwnProperty(z.length)||he(`Function '${y}' called with an invalid number of arguments (${z.length}) - expects one of (${u[f].overloadTable})!`),u[f].overloadTable[z.length].apply(this,z)},u[f].overloadTable=[],u[f].overloadTable[D.argCount]=D}},Ht=(u,f,y)=>{t.hasOwnProperty(u)?((y===void 0||t[u].overloadTable!==void 0&&t[u].overloadTable[y]!==void 0)&&he(`Cannot register public name '${u}' twice`),ht(t,u,u),t[u].overloadTable.hasOwnProperty(y)&&he(`Cannot register multiple overloads of a function with the same number of arguments (${y})!`),t[u].overloadTable[y]=f):(t[u]=f,t[u].argCount=y)},pn=48,fs=57,xr=u=>{u=u.replace(/[^a-zA-Z0-9_]/g,"$");var f=u.charCodeAt(0);return f>=pn&&f<=fs?`_${u}`:u};function Ki(u,f,y,D,z,$,Q,se){this.name=u,this.constructor=f,this.instancePrototype=y,this.rawDestructor=D,this.baseClass=z,this.getActualType=$,this.upcast=Q,this.downcast=se,this.pureVirtualFunctions=[]}var Zi=(u,f,y)=>{for(;f!==y;)f.upcast||he(`Expected null or instance of ${y.name}, got an instance of ${f.name}`),u=f.upcast(u),f=f.baseClass;return u},gi=u=>{if(u===null)return"null";var f=typeof u;return f==="object"||f==="array"||f==="function"?u.toString():""+u};function Mr(u,f){if(f===null)return this.isReference&&he(`null is not a valid ${this.name}`),0;f.$$||he(`Cannot pass "${gi(f)}" as a ${this.name}`),f.$$.ptr||he(`Cannot pass deleted object as a pointer of type ${this.name}`);var y=f.$$.ptrType.registeredClass,D=Zi(f.$$.ptr,y,this.registeredClass);return D}function Dn(u,f){var y;if(f===null)return this.isReference&&he(`null is not a valid ${this.name}`),this.isSmartPointer?(y=this.rawConstructor(),u!==null&&u.push(this.rawDestructor,y),y):0;(!f||!f.$$)&&he(`Cannot pass "${gi(f)}" as a ${this.name}`),f.$$.ptr||he(`Cannot pass deleted object as a pointer of type ${this.name}`),!this.isConst&&f.$$.ptrType.isConst&&he(`Cannot convert argument of type ${f.$$.smartPtrType?f.$$.smartPtrType.name:f.$$.ptrType.name} to parameter type ${this.name}`);var D=f.$$.ptrType.registeredClass;if(y=Zi(f.$$.ptr,D,this.registeredClass),this.isSmartPointer)switch(f.$$.smartPtr===void 0&&he("Passing raw pointer to smart pointer is illegal"),this.sharingPolicy){case 0:f.$$.smartPtrType===this?y=f.$$.smartPtr:he(`Cannot convert argument of type ${f.$$.smartPtrType?f.$$.smartPtrType.name:f.$$.ptrType.name} to parameter type ${this.name}`);break;case 1:y=f.$$.smartPtr;break;case 2:if(f.$$.smartPtrType===this)y=f.$$.smartPtr;else{var z=f.clone();y=this.rawShare(y,Ze.toHandle(()=>z.delete())),u!==null&&u.push(this.rawDestructor,y)}break;default:he("Unsupported sharing policy")}return y}function Ji(u,f){if(f===null)return this.isReference&&he(`null is not a valid ${this.name}`),0;f.$$||he(`Cannot pass "${gi(f)}" as a ${this.name}`),f.$$.ptr||he(`Cannot pass deleted object as a pointer of type ${this.name}`),f.$$.ptrType.isConst&&he(`Cannot convert argument of type ${f.$$.ptrType.name} to parameter type ${this.name}`);var y=f.$$.ptrType.registeredClass,D=Zi(f.$$.ptr,y,this.registeredClass);return D}var Qi=(u,f,y)=>{if(f===y)return u;if(y.baseClass===void 0)return null;var D=Qi(u,f,y.baseClass);return D===null?null:y.downcast(D)},Sr={},vi=(u,f)=>{for(f===void 0&&he("ptr should not be undefined");u.baseClass;)f=u.upcast(f),u=u.baseClass;return f},Er=(u,f)=>(f=vi(u,f),Sr[f]),Ln=(u,f)=>{(!f.ptrType||!f.ptr)&&J("makeClassHandle requires ptr and ptrType");var y=!!f.smartPtrType,D=!!f.smartPtr;return y!==D&&J("Both smartPtrType and smartPtr must be specified"),f.count={value:1},ue(Object.create(u,{$$:{value:f,writable:!0}}))};function yr(u){var f=this.getPointee(u);if(!f)return this.destructor(u),null;var y=Er(this.registeredClass,f);if(y!==void 0){if(y.$$.count.value===0)return y.$$.ptr=f,y.$$.smartPtr=u,y.clone();var D=y.clone();return this.destructor(u),D}function z(){return this.isSmartPointer?Ln(this.registeredClass.instancePrototype,{ptrType:this.pointeeType,ptr:f,smartPtrType:this,smartPtr:u}):Ln(this.registeredClass.instancePrototype,{ptrType:this,ptr:u})}var $=this.registeredClass.getActualType(f),Q=xt[$];if(!Q)return z.call(this);var se;this.isConst?se=Q.constPointerType:se=Q.pointerType;var pe=Qi(f,this.registeredClass,se.registeredClass);return pe===null?z.call(this):this.isSmartPointer?Ln(se.registeredClass.instancePrototype,{ptrType:se,ptr:pe,smartPtrType:this,smartPtr:u}):Ln(se.registeredClass.instancePrototype,{ptrType:se,ptr:pe})}var br=()=>{Object.assign(xi.prototype,{getPointee(u){return this.rawGetPointee&&(u=this.rawGetPointee(u)),u},destructor(u){this.rawDestructor?.(u)},readValueFromPointer:ft,fromWireType:yr})};function xi(u,f,y,D,z,$,Q,se,pe,Re,Oe){this.name=u,this.registeredClass=f,this.isReference=y,this.isConst=D,this.isSmartPointer=z,this.pointeeType=$,this.sharingPolicy=Q,this.rawGetPointee=se,this.rawConstructor=pe,this.rawShare=Re,this.rawDestructor=Oe,!z&&f.baseClass===void 0?D?(this.toWireType=Mr,this.destructorFunction=null):(this.toWireType=Ji,this.destructorFunction=null):this.toWireType=Dn}var Tr=(u,f,y)=>{t.hasOwnProperty(u)||J("Replacing nonexistent public symbol"),t[u].overloadTable!==void 0&&y!==void 0?t[u].overloadTable[y]=f:(t[u]=f,t[u].argCount=y)},Mi=u=>tr.get(u),hs=(u,f,y=[],D=!1)=>{var z=Mi(f),$=z(...y);function Q(se){return u[0]=="p"?se>>>0:se}return Q($)},ds=(u,f,y=!1)=>(...D)=>hs(u,f,D,y),rn=(u,f,y=!1)=>{u=Me(u);function D(){if(u.includes("p"))return ds(u,f,y);var $=Mi(f);return $}var z=D();return typeof z!="function"&&he(`unknown function pointer with signature ${u}: ${f}`),z};class M extends Error{}var B=u=>{var f=_o(u),y=Me(f);return $n(f),y},X=(u,f)=>{var y=[],D={};function z($){if(!D[$]&&!A[$]){if(_[$]){_[$].forEach(z);return}y.push($),D[$]=!0}}throw f.forEach(z),new M(`${u}: `+y.map(B).join([", "]))};function W(u,f,y,D,z,$,Q,se,pe,Re,Oe,it,ct){u>>>=0,f>>>=0,y>>>=0,D>>>=0,z>>>=0,$>>>=0,Q>>>=0,se>>>=0,pe>>>=0,Re>>>=0,Oe>>>=0,it>>>=0,ct>>>=0,Oe=Me(Oe),$=rn(z,$),se&&=rn(Q,se),Re&&=rn(pe,Re),ct=rn(it,ct);var rt=xr(Oe);Ht(rt,function(){X(`Cannot construct ${Oe} due to unbound types`,[D])}),ne([u,f,y],D?[D]:[],wt=>{wt=wt[0];var Ot,sn;D?(Ot=wt.registeredClass,sn=Ot.instancePrototype):sn=_e.prototype;var U=He(Oe,function(...Rt){if(Object.getPrototypeOf(this)!==H)throw new me(`Use 'new' to construct ${Oe}`);if(re.constructor_body===void 0)throw new me(`${Oe} has no accessible constructor`);var Kt=re.constructor_body[Rt.length];if(Kt===void 0)throw new me(`Tried to invoke ctor of ${Oe} with invalid number of parameters (${Rt.length}) - expected (${Object.keys(re.constructor_body).toString()}) parameters instead!`);return Kt.apply(this,Rt)}),H=Object.create(sn,{constructor:{value:U}});U.prototype=H;var re=new Ki(Oe,U,H,ct,Ot,$,se,Re);re.baseClass&&(re.baseClass.__derivedClasses??=[],re.baseClass.__derivedClasses.push(re));var fe=new xi(Oe,re,!0,!1,!1),ke=new xi(Oe+"*",re,!1,!1,!1),gt=new xi(Oe+" const*",re,!1,!0,!1);return xt[u]={pointerType:ke,constPointerType:gt},Tr(rt,U),[fe,ke,gt]})}var G=(u,f)=>{for(var y=[],D=0;D<u;D++)y.push(x[f+D*4>>>2>>>0]);return y};function Se(u){for(var f=1;f<u.length;++f)if(u[f]!==null&&u[f].destructorFunction===void 0)return!0;return!1}function Ce(u,f,y,D){var z=Se(u),$=u.length-2,Q=[],se=["fn"];f&&se.push("thisWired");for(var pe=0;pe<$;++pe)Q.push(`arg${pe}`),se.push(`arg${pe}Wired`);Q=Q.join(","),se=se.join(",");var Re=`return function (${Q}) {
...
`,it.push(ct)}if(Re+=(y||D?"var rv = ":"")+`invoker(${se});
...
`)}const pm={[vl]:"Linear",[xl]:"Reinhard",[Ml]:"Cineon",[Sl]:"ACESFilmic",[yl]:"AgX",[bl]:"Neutral",[El]:"Custom"};function mm(i,e){const t=pm[e];return t===void 0?(qe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const qr=new k;function _m(){ut.getLuminanceCoefficients(qr);const i=qr.x.toFixed(4),e=qr.y.toFixed(4),t=qr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),e}const Tm={[Yr]:"SHADOWMAP_TYPE_PCF",[cr]:"SHADOWMAP_TYPE_VSM"};function Am(i){return Tm[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const wm={[_i]:"ENVMAP_TYPE_CUBE",[Hi]:"ENVMAP_TYPE_CUBE",[is]:"ENVMAP_TYPE_CUBE_UV"};function Rm(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":wm[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Cm={[Hi]:"ENVMAP_MODE_REFRACTION"};function Pm(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Cm[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Dm={[$a]:"ENVMAP_BLENDING_MULTIPLY",[gu]:"ENVMAP_BLENDING_MIX",[vu]:"ENVMAP_BLENDING_ADD"};function Lm(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Dm[i.combine]||"ENVMAP_BLENDING_NONE"}function Um(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Im(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Am(t),l=Rm(t),d=Pm(t),p=Lm(t),m=Um(t),v=gm(t),S=vm(s),b=r.createProgram();let g,h,w=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+h);const R=w+g+a,T=w+h+o,C=sl(r,r.VERTEX_SHADER,R),P=sl(r,r.FRAGMENT_SHADER,T);r.attachShader(b,C),r.attachShader(b,P),t.index0AttributeName!==void 0?r.bindAttribLocation(b,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(b,0,"position"),r.linkProgram(b);function L(N){if(i.debug.checkShaderErrors){const Y=r.getProgramInfoLog(b)||"",q=r.getShaderInfoLog(C)||"",ee=r.getShaderInfoLog(P)||"",ie=Y.trim(),j=q.trim(),Z=ee.trim();let le=!0,ye=!0;if(r.getProgramParameter(b,r.LINK_STATUS)===!1)if(le=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,b,C,P);else{const xe=ol(r,C,"vertex"),we=ol(r,P,"fragment");pt("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(b,r.VALIDATE_STATUS)+`
