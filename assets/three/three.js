(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function t(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(r){if(r.ep)return;r.ep=!0;const s=t(r);fetch(r.href,s)}})();const hu="modulepreload",du=function(i){return"/"+i},To={},pu=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let u=function(c){return Promise.all(c.map(h=>Promise.resolve(h).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),o=a?.nonce||a?.getAttribute("nonce");r=u(t.map(c=>{if(c=du(c),c in To)return;To[c]=!0;const h=c.endsWith(".css"),p=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const m=document.createElement("link");if(m.rel=h?"stylesheet":hu,h||(m.as="script"),m.crossOrigin="",m.href=c,o&&m.setAttribute("nonce",o),document.head.appendChild(m),h)return new Promise((v,S)=>{m.addEventListener("load",v),m.addEventListener("error",()=>S(new Error(`Unable to preload CSS for ${c}`)))})}))}function s(a){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=a,window.dispatchEvent(o),!o.defaultPrevented)throw a}return r.then(a=>{for(const o of a||[])o.status==="rejected"&&s(o.reason);return e().catch(s)})};var mu=(()=>{var i=import.meta.url;return(async function(e={}){var t,n=e,r,s,a=new Promise((l,f)=>{r=l,s=f}),o=typeof window=="object",u=typeof importScripts=="function",c=typeof process=="object"&&typeof process.versions=="object"&&typeof process.versions.node=="string";if(c){const{createRequire:l}=await pu(()=>import("./__vite-browser-external.js"),[]);var h=l(import.meta.url)}var p=!1;n.setup=function(){if(p)return;p=!0,n.initTBB();function l(U,W,re=(pe=>pe)){if(W)for(let pe of W)U.push_back(re(pe));return U}function f(U,W=(re=>re)){const re=[],pe=U.size();for(let Xe=0;Xe<pe;Xe++)re.push(W(U.get(Xe)));return re}function E(U,W=(re=>re)){const re=[],pe=U.size();for(let Xe=0;Xe<pe;Xe++){const yt=U.get(Xe),Lt=yt.size(),rn=[];for(let zt=0;zt<Lt;zt++)rn.push(W(yt.get(zt)));re.push(rn)}return re}function C(U){return U[0].length<3&&(U=[U]),l(new n.Vector2_vec2,U,W=>l(new n.Vector_vec2,W,re=>re instanceof Array?{x:re[0],y:re[1]}:re))}function z(U){for(let W=0;W<U.size();W++)U.get(W).delete();U.delete()}function Y(U){return U[0]instanceof Array?{x:U[0][0],y:U[0][1]}:typeof U[0]=="number"?{x:U[0]||0,y:U[1]||0}:U[0]}function ae(U){return U[0]instanceof Array?{x:U[0][0],y:U[0][1],z:U[0][2]}:typeof U[0]=="number"?{x:U[0]||0,y:U[1]||0,z:U[2]||0}:U[0]}function J(U){return U=="EvenOdd"?0:U=="NonZero"?1:U=="Negative"?3:2}function fe(U){return U=="Round"?1:U=="Miter"?2:0}const de=n.CrossSection;function Se(U,W="Positive"){if(U instanceof de)return U;{const re=C(U),pe=new de(re,J(W));return z(re),pe}}n.CrossSection.prototype.translate=function(...U){return this._Translate(Y(U))},n.CrossSection.prototype.scale=function(U){return typeof U=="number"?this._Scale({x:U,y:U}):this._Scale(Y([U]))},n.CrossSection.prototype.mirror=function(U){return this._Mirror(Y([U]))},n.CrossSection.prototype.warp=function(U){const W=nr(function(pe){const Xe=we(pe,"double"),yt=we(pe+8,"double"),Lt=[Xe,yt];U(Lt),b(pe,Lt[0],"double"),b(pe+8,Lt[1],"double")},"vi"),re=this._Warp(W);return ir(W),re},n.CrossSection.prototype.decompose=function(){const U=this._Decompose(),W=f(U);return U.delete(),W},n.CrossSection.prototype.bounds=function(){const U=this._Bounds();return{min:["x","y"].map(W=>U.min[W]),max:["x","y"].map(W=>U.max[W])}},n.CrossSection.prototype.offset=function(U,W="Round",re=2,pe=0){return this._Offset(U,fe(W),re,pe)},n.CrossSection.prototype.simplify=function(U=1e-6){return this._Simplify(U)},n.CrossSection.prototype.extrude=function(U,W=0,re=0,pe=[1,1],Xe=!1){pe=Y([pe]);const yt=n._Extrude(this._ToPolygons(),U,W,re,pe);return Xe?yt.translate([0,0,-U/2]):yt},n.CrossSection.prototype.revolve=function(U=0,W=360){return n._Revolve(this._ToPolygons(),U,W)},n.CrossSection.prototype.add=function(U){return this._add(Se(U))},n.CrossSection.prototype.subtract=function(U){return this._subtract(Se(U))},n.CrossSection.prototype.intersect=function(U){return this._intersect(Se(U))},n.CrossSection.prototype.toPolygons=function(){const U=this._ToPolygons(),W=E(U,re=>[re.x,re.y]);return U.delete(),W},n.Manifold.prototype.smoothOut=function(U=60,W=0){return this._SmoothOut(U,W)},n.Manifold.prototype.warp=function(U){const W=nr(function(Xe){const yt=we(Xe,"double"),Lt=we(Xe+8,"double"),rn=we(Xe+16,"double"),zt=[yt,Lt,rn];U(zt),b(Xe,zt[0],"double"),b(Xe+8,zt[1],"double"),b(Xe+16,zt[2],"double")},"vi"),re=this._Warp(W);ir(W);const pe=re.status();if(pe!=="NoError")throw new n.ManifoldError(pe);return re},n.Manifold.prototype.calculateNormals=function(U,W=60){return this._CalculateNormals(U,W)},n.Manifold.prototype.setProperties=function(U,W){const re=this.numProp(),pe=nr(function(yt,Lt,rn){const zt=[];for(let wt=0;wt<U;++wt)zt[wt]=we(yt+8*wt,"double");const wi=[];for(let wt=0;wt<3;++wt)wi[wt]=we(Lt+8*wt,"double");const Ri=[];for(let wt=0;wt<re;++wt)Ri[wt]=we(rn+8*wt,"double");W(zt,wi,Ri);for(let wt=0;wt<U;++wt)b(yt+8*wt,zt[wt],"double")},"viii"),Xe=this._SetProperties(U,pe);return ir(pe),Xe},n.Manifold.prototype.translate=function(...U){return this._Translate(ae(U))},n.Manifold.prototype.rotate=function(U,W,re){return Array.isArray(U)?this._Rotate(...U):this._Rotate(U,W||0,re||0)},n.Manifold.prototype.scale=function(U){return typeof U=="number"?this._Scale({x:U,y:U,z:U}):this._Scale(ae([U]))},n.Manifold.prototype.mirror=function(U){return this._Mirror(ae([U]))},n.Manifold.prototype.trimByPlane=function(U,W=0){return this._TrimByPlane(ae([U]),W)},n.Manifold.prototype.slice=function(U=0){const W=this._Slice(U),re=new de(W,J("Positive"));return z(W),re},n.Manifold.prototype.project=function(){const U=this._Project(),W=new de(U,J("Positive"));return z(U),W},n.Manifold.prototype.split=function(U){const W=this._Split(U),re=f(W);return W.delete(),re},n.Manifold.prototype.splitByPlane=function(U,W=0){const re=this._SplitByPlane(ae([U]),W),pe=f(re);return re.delete(),pe},n.Manifold.prototype.decompose=function(){const U=this._Decompose(),W=f(U);return U.delete(),W},n.Manifold.prototype.boundingBox=function(){const U=this._boundingBox();return{min:["x","y","z"].map(W=>U.min[W]),max:["x","y","z"].map(W=>U.max[W])}};class We{constructor({numProp:W=3,triVerts:re=new Uint32Array,vertProperties:pe=new Float32Array,mergeFromVert:Xe,mergeToVert:yt,runIndex:Lt,runOriginalID:rn,faceID:zt,halfedgeTangent:wi,runTransform:Ri,tolerance:wt=0}={}){this.numProp=W,this.triVerts=re,this.vertProperties=pe,this.mergeFromVert=Xe,this.mergeToVert=yt,this.runIndex=Lt,this.runOriginalID=rn,this.faceID=zt,this.halfedgeTangent=wi,this.runTransform=Ri,this.tolerance=wt}get numTri(){return this.triVerts.length/3}get numVert(){return this.vertProperties.length/this.numProp}get numRun(){return this.runOriginalID.length}merge(){const{changed:W,mesh:re}=n._Merge(this);return Object.assign(this,{...re}),W}verts(W){return this.triVerts.subarray(3*W,3*(W+1))}position(W){return this.vertProperties.subarray(this.numProp*W,this.numProp*W+3)}extras(W){return this.vertProperties.subarray(this.numProp*W+3,this.numProp*(W+1))}tangent(W){return this.halfedgeTangent.subarray(4*W,4*(W+1))}transform(W){const re=new Array(16);for(const pe of[0,1,2,3])for(const Xe of[0,1,2])re[4*pe+Xe]=this.runTransform[12*W+3*pe+Xe];return re[15]=1,re}}n.Mesh=We,n.Manifold.prototype.getMesh=function(U=-1){return new We(this._GetMeshJS(U))},n.ManifoldError=function(W,...re){let pe="Unknown error";switch(W){case"NonFiniteVertex":pe="Non-finite vertex";break;case"NotManifold":pe="Not manifold";break;case"VertexOutOfBounds":pe="Vertex index out of bounds";break;case"PropertiesWrongLength":pe="Properties have wrong length";break;case"MissingPositionProperties":pe="Less than three properties";break;case"MergeVectorsDifferentLengths":pe="Merge vectors have different lengths";break;case"MergeIndexOutOfBounds":pe="Merge index out of bounds";break;case"TransformWrongLength":pe="Transform vector has wrong length";break;case"RunIndexWrongLength":pe="Run index vector has wrong length";break;case"FaceIDWrongLength":pe="Face ID vector has wrong length";case"InvalidConstruction":pe="Manifold constructed with invalid parameters"}const Xe=Error.apply(this,[pe,...re]);Xe.name=this.name="ManifoldError",this.message=Xe.message,this.stack=Xe.stack,this.code=W},n.ManifoldError.prototype=Object.create(Error.prototype,{constructor:{value:n.ManifoldError,writable:!0,configurable:!0}}),n.CrossSection=function(U,W="Positive"){const re=C(U),pe=new de(re,J(W));return z(re),pe},n.CrossSection.ofPolygons=function(U,W="Positive"){return new n.CrossSection(U,W)},n.CrossSection.square=function(...U){let W;U.length==0?W={x:1,y:1}:typeof U[0]=="number"?W={x:U[0],y:U[0]}:W=Y(U);const re=U[1]||!1;return n._Square(W,re)},n.CrossSection.circle=function(U,W=0){return n._Circle(U,W)};function ut(U){return function(...W){W.length==1&&(W=W[0]);const re=new n.Vector_crossSection;for(const Xe of W)re.push_back(Se(Xe));const pe=n["_crossSection"+U](re);return re.delete(),pe}}n.CrossSection.compose=ut("Compose"),n.CrossSection.union=ut("UnionN"),n.CrossSection.difference=ut("DifferenceN"),n.CrossSection.intersection=ut("IntersectionN");function It(U,W){l(U,W,re=>re instanceof Array?{x:re[0],y:re[1]}:re)}n.CrossSection.hull=function(...U){U.length==1&&(U=U[0]);let W=new n.Vector_vec2;for(const pe of U)if(pe instanceof de)n._crossSectionCollectVertices(W,pe);else if(pe instanceof Array&&pe.length==2&&typeof pe[0]=="number")W.push_back({x:pe[0],y:pe[1]});else if(pe.x)W.push_back(pe);else{const yt=pe[0].length==2&&typeof pe[0][0]=="number"||pe[0].x?[pe]:pe;for(const Lt of yt)It(W,Lt)}const re=n._crossSectionHullPoints(W);return W.delete(),re},n.CrossSection.prototype=Object.create(de.prototype),Object.defineProperty(n.CrossSection,Symbol.hasInstance,{get:()=>U=>U instanceof de});const Ct=n.Manifold;n.Manifold=function(U){const W=new Ct(U),re=W.status();if(re!=="NoError")throw new n.ManifoldError(re);return W},n.Manifold.ofMesh=function(U){return new n.Manifold(U)},n.Manifold.tetrahedron=function(){return n._Tetrahedron()},n.Manifold.cube=function(...U){let W;U.length==0?W={x:1,y:1,z:1}:typeof U[0]=="number"?W={x:U[0],y:U[0],z:U[0]}:W=ae(U);const re=U[1]||!1;return n._Cube(W,re)},n.Manifold.cylinder=function(U,W,re=-1,pe=0,Xe=!1){return n._Cylinder(U,W,re,pe,Xe)},n.Manifold.sphere=function(U,W=0){return n._Sphere(U,W)},n.Manifold.smooth=function(U,W=[]){const re=new n.Vector_smoothness;l(re,W);const pe=n._Smooth(U,re);return re.delete(),pe},n.Manifold.extrude=function(U,W,re=0,pe=0,Xe=[1,1],yt=!1){return(U instanceof de?U:n.CrossSection(U,"Positive")).extrude(W,re,pe,Xe,yt)},n.Manifold.revolve=function(U,W=0,re=360){return(U instanceof de?U:n.CrossSection(U,"Positive")).revolve(W,re)},n.Manifold.reserveIDs=function(U){return n._ReserveIDs(U)};function pn(U){return function(...W){W.length==1&&(W=W[0]);const re=new n.Vector_manifold;for(const Xe of W)re.push_back(Xe);const pe=n["_manifold"+U+"N"](re);return re.delete(),pe}}n.Manifold.union=pn("Union"),n.Manifold.compose=n.Manifold.union,n.Manifold.difference=pn("Difference"),n.Manifold.intersection=pn("Intersection"),n.Manifold.levelSet=function(U,W,re,pe=0,Xe=-1){const yt={min:{x:W.min[0],y:W.min[1],z:W.min[2]},max:{x:W.max[0],y:W.max[1],z:W.max[2]}},Lt=nr(function(zt){const wi=we(zt,"double"),Ri=we(zt+8,"double"),wt=we(zt+16,"double");return U([wi,Ri,wt])},"di"),rn=n._LevelSet(Lt,yt,re,pe,Xe);return ir(Lt),rn};function mn(U,W){l(U,W,re=>re instanceof Array?{x:re[0],y:re[1],z:re[2]}:re)}n.Manifold.hull=function(...U){U.length==1&&(U=U[0]);let W=new n.Vector_vec3;for(const pe of U)pe instanceof Ct?n._manifoldCollectVertices(W,pe):pe instanceof Array&&pe.length==3&&typeof pe[0]=="number"?W.push_back({x:pe[0],y:pe[1],z:pe[2]}):pe.x?W.push_back(pe):mn(W,pe);const re=n._manifoldHullPoints(W);return W.delete(),re},n.Manifold.prototype=Object.create(Ct.prototype),Object.defineProperty(n.Manifold,Symbol.hasInstance,{get:()=>U=>U instanceof Ct}),n.triangulate=function(U,W=-1,re=!0){const pe=C(U),Xe=f(n._Triangulate(pe,W,re),yt=>[yt[0],yt[1],yt[2]]);return z(pe),Xe}};var m=Object.assign({},n),v="";function S(l){return n.locateFile?n.locateFile(l,v):v+l}var T,_;if(c){var d=h("fs"),A=h("path");v=h("url").fileURLToPath(new URL("/assets/three/manifold.js",import.meta.url)),_=l=>{l=bt(l)?new URL(l):A.normalize(l);var f=d.readFileSync(l);return f},T=(l,f=!0)=>(l=bt(l)?new URL(l):A.normalize(l),new Promise((E,C)=>{d.readFile(l,f?void 0:"utf8",(z,Y)=>{z?C(z):E(f?Y.buffer:Y)})})),!n.thisProgram&&process.argv.length>1&&process.argv[1].replace(/\\/g,"/"),process.argv.slice(2)}else(o||u)&&(u?v=self.location.href:typeof document<"u"&&document.currentScript&&(v=document.currentScript.src),i&&(v=i),v.startsWith("blob:")?v="":v=v.substr(0,v.replace(/[?#].*/,"").lastIndexOf("/")+1),u&&(_=l=>{var f=new XMLHttpRequest;return f.open("GET",l,!1),f.responseType="arraybuffer",f.send(null),new Uint8Array(f.response)}),T=l=>bt(l)?new Promise((f,E)=>{var C=new XMLHttpRequest;C.open("GET",l,!0),C.responseType="arraybuffer",C.onload=()=>{(C.status==200||C.status==0&&C.response)&&E(C.response),f(C.status)},C.onerror=f,C.send(null)}):fetch(l,{credentials:"same-origin"}).then(f=>f.ok?f.arrayBuffer():Promise.reject(new Error(f.status+" : "+f.url))));n.print||console.log.bind(console);var R=n.printErr||console.error.bind(console);Object.assign(n,m),m=null,n.arguments&&n.arguments,n.thisProgram&&n.thisProgram,n.quit&&n.quit;var w;n.wasmBinary&&(w=n.wasmBinary);var P,D=!1,L,V,x,y,F,H,$,ee;function ie(){var l=P.buffer;n.HEAP8=L=new Int8Array(l),n.HEAP16=x=new Int16Array(l),n.HEAPU8=V=new Uint8Array(l),n.HEAPU16=y=new Uint16Array(l),n.HEAP32=F=new Int32Array(l),n.HEAPU32=H=new Uint32Array(l),n.HEAPF32=$=new Float32Array(l),n.HEAPF64=ee=new Float64Array(l)}var K=[],Z=[],ce=[];function Ae(){if(n.preRun)for(typeof n.preRun=="function"&&(n.preRun=[n.preRun]);n.preRun.length;)Qe(n.preRun.shift());mt(K)}function Me(){mt(Z)}function Re(){if(n.postRun)for(typeof n.postRun=="function"&&(n.postRun=[n.postRun]);n.postRun.length;)Tt(n.postRun.shift());mt(ce)}function Qe(l){K.unshift(l)}function qe(l){Z.unshift(l)}function Tt(l){ce.unshift(l)}var ot=0,ne=null;function ue(l){ot++,n.monitorRunDependencies?.(ot)}function Ie(l){if(ot--,n.monitorRunDependencies?.(ot),ot==0&&ne){var f=ne;ne=null,f()}}function ke(l){n.onAbort?.(l),l="Aborted("+l+")",R(l),D=!0,l+=". Build with -sASSERTIONS for more info.";var f=new WebAssembly.RuntimeError(l);throw s(f),f}var Fe="data:application/octet-stream;base64,",tt=l=>l.startsWith(Fe),bt=l=>l.startsWith("file://");function nt(){if(n.locateFile){var l="manifold.wasm";return tt(l)?l:S(l)}return new URL("/assets/three/manifold.wasm",import.meta.url).href}var st;function pt(l){if(l==st&&w)return new Uint8Array(w);if(_)return _(l);throw"both async and sync fetching of the wasm failed"}function Ye(l){return w?Promise.resolve().then(()=>pt(l)):T(l).then(f=>new Uint8Array(f),()=>pt(l))}function At(l,f,E){return Ye(l).then(C=>WebAssembly.instantiate(C,f)).then(E,C=>{R(`failed to asynchronously prepare wasm: ${C}`),ke(C)})}function I(l,f,E,C){return!l&&typeof WebAssembly.instantiateStreaming=="function"&&!tt(f)&&!bt(f)&&!c&&typeof fetch=="function"?fetch(f,{credentials:"same-origin"}).then(z=>{var Y=WebAssembly.instantiateStreaming(z,E);return Y.then(C,function(ae){return R(`wasm streaming compile failed: ${ae}`),R("falling back to ArrayBuffer instantiation"),At(f,E,C)})}):At(f,E,C)}function Rt(){return{a:uu}}function ct(){var l=Rt();function f(C,z){return dn=C.exports,dn=fu(dn),P=dn.J,ie(),vt=dn.M,qe(dn.K),Ie(),dn}ue();function E(C){f(C.instance)}if(n.instantiateWasm)try{return n.instantiateWasm(l,f)}catch(C){R(`Module.instantiateWasm callback failed with error: ${C}`),s(C)}return st||(st=nt()),I(w,st,l,E).catch(s),{}}var mt=l=>{for(;l.length>0;)l.shift()(n)};function we(l,f="i8"){switch(f.endsWith("*")&&(f="*"),f){case"i1":return L[l>>>0];case"i8":return L[l>>>0];case"i16":return x[l>>>1>>>0];case"i32":return F[l>>>2>>>0];case"i64":ke("to do getValue(i64) use WASM_BIGINT");case"float":return $[l>>>2>>>0];case"double":return ee[l>>>3>>>0];case"*":return H[l>>>2>>>0];default:ke(`invalid type for getValue: ${f}`)}}n.noExitRuntime;function b(l,f,E="i8"){switch(E.endsWith("*")&&(E="*"),E){case"i1":L[l>>>0]=f;break;case"i8":L[l>>>0]=f;break;case"i16":x[l>>>1>>>0]=f;break;case"i32":F[l>>>2>>>0]=f;break;case"i64":ke("to do setValue(i64) use WASM_BIGINT");case"float":$[l>>>2>>>0]=f;break;case"double":ee[l>>>3>>>0]=f;break;case"*":H[l>>>2>>>0]=f;break;default:ke(`invalid type for setValue: ${E}`)}}class g{constructor(f){this.excPtr=f,this.ptr=f-24}set_type(f){H[this.ptr+4>>>2>>>0]=f}get_type(){return H[this.ptr+4>>>2>>>0]}set_destructor(f){H[this.ptr+8>>>2>>>0]=f}get_destructor(){return H[this.ptr+8>>>2>>>0]}set_caught(f){f=f?1:0,L[this.ptr+12>>>0]=f}get_caught(){return L[this.ptr+12>>>0]!=0}set_rethrown(f){f=f?1:0,L[this.ptr+13>>>0]=f}get_rethrown(){return L[this.ptr+13>>>0]!=0}init(f,E){this.set_adjusted_ptr(0),this.set_type(f),this.set_destructor(E)}set_adjusted_ptr(f){H[this.ptr+16>>>2>>>0]=f}get_adjusted_ptr(){return H[this.ptr+16>>>2>>>0]}get_exception_ptr(){var f=Eo(this.get_type());if(f)return H[this.excPtr>>>2>>>0];var E=this.get_adjusted_ptr();return E!==0?E:this.excPtr}}var O=0;function te(l,f,E){l>>>=0,f>>>=0,E>>>=0;var C=new g(l);throw C.init(f,E),O=l,O}var oe=()=>{ke("")},j={},Ne=l=>{for(;l.length;){var f=l.pop(),E=l.pop();E(f)}};function _e(l){return this.fromWireType(H[l>>>2>>>0])}var Pe={},Ve={},he={},ge,De=l=>{throw new ge(l)},Le=(l,f,E)=>{l.forEach(function(J){he[J]=f});function C(J){var fe=E(J);fe.length!==l.length&&De("Mismatched type converter count");for(var de=0;de<l.length;++de)me(l[de],fe[de])}var z=new Array(f.length),Y=[],ae=0;f.forEach((J,fe)=>{Ve.hasOwnProperty(J)?z[fe]=Ve[J]:(Y.push(J),Pe.hasOwnProperty(J)||(Pe[J]=[]),Pe[J].push(()=>{z[fe]=Ve[J],++ae,ae===Y.length&&C(z)}))}),Y.length===0&&C(z)},ve=function(l){l>>>=0;var f=j[l];delete j[l];var E=f.rawConstructor,C=f.rawDestructor,z=f.fields,Y=z.map(ae=>ae.getterReturnType).concat(z.map(ae=>ae.setterArgumentType));Le([l],Y,ae=>{var J={};return z.forEach((fe,de)=>{var Se=fe.fieldName,We=ae[de],ut=fe.getter,It=fe.getterContext,Ct=ae[de+z.length],pn=fe.setter,mn=fe.setterContext;J[Se]={read:U=>We.fromWireType(ut(It,U)),write:(U,W)=>{var re=[];pn(mn,U,Ct.toWireType(re,W)),Ne(re)}}}),[{name:f.name,fromWireType:fe=>{var de={};for(var Se in J)de[Se]=J[Se].read(fe);return C(fe),de},toWireType:(fe,de)=>{for(var Se in J)if(!(Se in de))throw new TypeError(`Missing field: "${Se}"`);var We=E();for(Se in J)J[Se].write(We,de[Se]);return fe!==null&&fe.push(C,We),We},argPackAdvance:ze,readValueFromPointer:_e,destructorFunction:C}]})};function je(l,f,E,C,z){}var N=()=>{for(var l=new Array(256),f=0;f<256;++f)l[f]=String.fromCharCode(f);Ee=l},Ee,le=l=>{for(var f="",E=l;V[E>>>0];)f+=Ee[V[E++>>>0]];return f},ye,Q=l=>{throw new ye(l)};function se(l,f,E={}){var C=f.name;if(l||Q(`type "${C}" must have a positive integer typeid pointer`),Ve.hasOwnProperty(l)){if(E.ignoreDuplicateRegistrations)return;Q(`Cannot register type '${C}' twice`)}if(Ve[l]=f,delete he[l],Pe.hasOwnProperty(l)){var z=Pe[l];delete Pe[l],z.forEach(Y=>Y())}}function me(l,f,E={}){if(!("argPackAdvance"in f))throw new TypeError("registerType registeredInstance requires argPackAdvance");return se(l,f,E)}var ze=8;function St(l,f,E,C){l>>>=0,f>>>=0,f=le(f),me(l,{name:f,fromWireType:function(z){return!!z},toWireType:function(z,Y){return Y?E:C},argPackAdvance:ze,readValueFromPointer:function(z){return this.fromWireType(V[z>>>0])},destructorFunction:null})}var ht=l=>({count:l.count,deleteScheduled:l.deleteScheduled,preservePointerOnDelete:l.preservePointerOnDelete,ptr:l.ptr,ptrType:l.ptrType,smartPtr:l.smartPtr,smartPtrType:l.smartPtrType}),Jt=l=>{function f(E){return E.$$.ptrType.registeredClass.name}Q(f(l)+" instance already deleted")},nn=!1,Sr=l=>{},Er=l=>{l.smartPtr?l.smartPtrType.rawDestructor(l.smartPtr):l.ptrType.registeredClass.rawDestructor(l.ptr)},Ei=l=>{l.count.value-=1;var f=l.count.value===0;f&&Er(l)},yr=(l,f,E)=>{if(f===E)return l;if(E.baseClass===void 0)return null;var C=yr(l,f,E.baseClass);return C===null?null:E.downcast(C)},er={},Tr=()=>Object.keys(En).length,Un=()=>{var l=[];for(var f in En)En.hasOwnProperty(f)&&l.push(En[f]);return l},Fn=[],yi=()=>{for(;Fn.length;){var l=Fn.pop();l.$$.deleteScheduled=!1,l.delete()}},Kn,Ti=l=>{Kn=l,Fn.length&&Kn&&Kn(yi)},br=()=>{n.getInheritedInstanceCount=Tr,n.getLiveInheritedInstances=Un,n.flushPendingDeletes=yi,n.setDelayFunction=Ti},En={},Ar=(l,f)=>{for(f===void 0&&Q("ptr should not be undefined");l.baseClass;)f=l.upcast(f),l=l.baseClass;return f},wr=(l,f)=>(f=Ar(l,f),En[f]),bi=(l,f)=>{(!f.ptrType||!f.ptr)&&De("makeClassHandle requires ptr and ptrType");var E=!!f.smartPtrType,C=!!f.smartPtr;return E!==C&&De("Both smartPtrType and smartPtr must be specified"),f.count={value:1},oi(Object.create(l,{$$:{value:f,writable:!0}}))};function ps(l){var f=this.getPointee(l);if(!f)return this.destructor(l),null;var E=wr(this.registeredClass,f);if(E!==void 0){if(E.$$.count.value===0)return E.$$.ptr=f,E.$$.smartPtr=l,E.clone();var C=E.clone();return this.destructor(l),C}function z(){return this.isSmartPointer?bi(this.registeredClass.instancePrototype,{ptrType:this.pointeeType,ptr:f,smartPtrType:this,smartPtr:l}):bi(this.registeredClass.instancePrototype,{ptrType:this,ptr:l})}var Y=this.registeredClass.getActualType(f),ae=er[Y];if(!ae)return z.call(this);var J;this.isConst?J=ae.constPointerType:J=ae.pointerType;var fe=yr(f,this.registeredClass,J.registeredClass);return fe===null?z.call(this):this.isSmartPointer?bi(J.registeredClass.instancePrototype,{ptrType:J,ptr:fe,smartPtrType:this,smartPtr:l}):bi(J.registeredClass.instancePrototype,{ptrType:J,ptr:fe})}var oi=l=>typeof FinalizationRegistry>"u"?(oi=f=>f,l):(nn=new FinalizationRegistry(f=>{Ei(f.$$)}),oi=f=>{var E=f.$$,C=!!E.smartPtr;if(C){var z={$$:E};nn.register(f,z,f)}return f},Sr=f=>nn.unregister(f),oi(l)),ms=()=>{Object.assign(Ai.prototype,{isAliasOf(l){if(!(this instanceof Ai)||!(l instanceof Ai))return!1;var f=this.$$.ptrType.registeredClass,E=this.$$.ptr;l.$$=l.$$;for(var C=l.$$.ptrType.registeredClass,z=l.$$.ptr;f.baseClass;)E=f.upcast(E),f=f.baseClass;for(;C.baseClass;)z=C.upcast(z),C=C.baseClass;return f===C&&E===z},clone(){if(this.$$.ptr||Jt(this),this.$$.preservePointerOnDelete)return this.$$.count.value+=1,this;var l=oi(Object.create(Object.getPrototypeOf(this),{$$:{value:ht(this.$$)}}));return l.$$.count.value+=1,l.$$.deleteScheduled=!1,l},delete(){this.$$.ptr||Jt(this),this.$$.deleteScheduled&&!this.$$.preservePointerOnDelete&&Q("Object already scheduled for deletion"),Sr(this),Ei(this.$$),this.$$.preservePointerOnDelete||(this.$$.smartPtr=void 0,this.$$.ptr=void 0)},isDeleted(){return!this.$$.ptr},deleteLater(){return this.$$.ptr||Jt(this),this.$$.deleteScheduled&&!this.$$.preservePointerOnDelete&&Q("Object already scheduled for deletion"),Fn.push(this),Fn.length===1&&Kn&&Kn(yi),this.$$.deleteScheduled=!0,this}})};function Ai(){}var Zn=(l,f)=>Object.defineProperty(f,"name",{value:l}),M=(l,f,E)=>{if(l[f].overloadTable===void 0){var C=l[f];l[f]=function(...z){return l[f].overloadTable.hasOwnProperty(z.length)||Q(`Function '${E}' called with an invalid number of arguments (${z.length}) - expects one of (${l[f].overloadTable})!`),l[f].overloadTable[z.length].apply(this,z)},l[f].overloadTable=[],l[f].overloadTable[C.argCount]=C}},B=(l,f,E)=>{n.hasOwnProperty(l)?((E===void 0||n[l].overloadTable!==void 0&&n[l].overloadTable[E]!==void 0)&&Q(`Cannot register public name '${l}' twice`),M(n,l,l),n.hasOwnProperty(E)&&Q(`Cannot register multiple overloads of a function with the same number of arguments (${E})!`),n[l].overloadTable[E]=f):(n[l]=f,E!==void 0&&(n[l].numArguments=E))},q=48,X=57,G=l=>{if(l===void 0)return"_unknown";l=l.replace(/[^a-zA-Z0-9_]/g,"$");var f=l.charCodeAt(0);return f>=q&&f<=X?`_${l}`:l};function xe(l,f,E,C,z,Y,ae,J){this.name=l,this.constructor=f,this.instancePrototype=E,this.rawDestructor=C,this.baseClass=z,this.getActualType=Y,this.upcast=ae,this.downcast=J,this.pureVirtualFunctions=[]}var Ce=(l,f,E)=>{for(;f!==E;)f.upcast||Q(`Expected null or instance of ${E.name}, got an instance of ${f.name}`),l=f.upcast(l),f=f.baseClass;return l};function Te(l,f){if(f===null)return this.isReference&&Q(`null is not a valid ${this.name}`),0;f.$$||Q(`Cannot pass "${vs(f)}" as a ${this.name}`),f.$$.ptr||Q(`Cannot pass deleted object as a pointer of type ${this.name}`);var E=f.$$.ptrType.registeredClass,C=Ce(f.$$.ptr,E,this.registeredClass);return C}function Ue(l,f){var E;if(f===null)return this.isReference&&Q(`null is not a valid ${this.name}`),this.isSmartPointer?(E=this.rawConstructor(),l!==null&&l.push(this.rawDestructor,E),E):0;(!f||!f.$$)&&Q(`Cannot pass "${vs(f)}" as a ${this.name}`),f.$$.ptr||Q(`Cannot pass deleted object as a pointer of type ${this.name}`),!this.isConst&&f.$$.ptrType.isConst&&Q(`Cannot convert argument of type ${f.$$.smartPtrType?f.$$.smartPtrType.name:f.$$.ptrType.name} to parameter type ${this.name}`);var C=f.$$.ptrType.registeredClass;if(E=Ce(f.$$.ptr,C,this.registeredClass),this.isSmartPointer)switch(f.$$.smartPtr===void 0&&Q("Passing raw pointer to smart pointer is illegal"),this.sharingPolicy){case 0:f.$$.smartPtrType===this?E=f.$$.smartPtr:Q(`Cannot convert argument of type ${f.$$.smartPtrType?f.$$.smartPtrType.name:f.$$.ptrType.name} to parameter type ${this.name}`);break;case 1:E=f.$$.smartPtr;break;case 2:if(f.$$.smartPtrType===this)E=f.$$.smartPtr;else{var z=f.clone();E=this.rawShare(E,Vt.toHandle(()=>z.delete())),l!==null&&l.push(this.rawDestructor,E)}break;default:Q("Unsupporting sharing policy")}return E}function Oe(l,f){if(f===null)return this.isReference&&Q(`null is not a valid ${this.name}`),0;f.$$||Q(`Cannot pass "${vs(f)}" as a ${this.name}`),f.$$.ptr||Q(`Cannot pass deleted object as a pointer of type ${this.name}`),f.$$.ptrType.isConst&&Q(`Cannot convert argument of type ${f.$$.ptrType.name} to parameter type ${this.name}`);var E=f.$$.ptrType.registeredClass,C=Ce(f.$$.ptr,E,this.registeredClass);return C}var He=()=>{Object.assign(Be.prototype,{getPointee(l){return this.rawGetPointee&&(l=this.rawGetPointee(l)),l},destructor(l){this.rawDestructor?.(l)},argPackAdvance:ze,readValueFromPointer:_e,fromWireType:ps})};function Be(l,f,E,C,z,Y,ae,J,fe,de,Se){this.name=l,this.registeredClass=f,this.isReference=E,this.isConst=C,this.isSmartPointer=z,this.pointeeType=Y,this.sharingPolicy=ae,this.rawGetPointee=J,this.rawConstructor=fe,this.rawShare=de,this.rawDestructor=Se,!z&&f.baseClass===void 0?C?(this.toWireType=Te,this.destructorFunction=null):(this.toWireType=Oe,this.destructorFunction=null):this.toWireType=Ue}var Ke=(l,f,E)=>{n.hasOwnProperty(l)||De("Replacing nonexistent public symbol"),n[l].overloadTable!==void 0&&E!==void 0?n[l].overloadTable[E]=f:(n[l]=f,n[l].argCount=E)},_t=(l,f,E)=>{l=l.replace(/p/g,"i");var C=n["dynCall_"+l];return C(f,...E)},vt,Et=l=>vt.get(l),xt=(l,f,E=[])=>{if(l.includes("j"))return _t(l,f,E);var C=Et(f)(...E);return l[0]=="p"?C>>>0:C},Ge=(l,f)=>(...E)=>xt(l,f,E),Ze=(l,f)=>{l=le(l);function E(){return l.includes("j")||l.includes("p")?Ge(l,f):Et(f)}var C=E();return typeof C!="function"&&Q(`unknown function pointer with signature ${l}: ${f}`),C},at=(l,f)=>{var E=Zn(f,function(C){this.name=f,this.message=C;var z=new Error(C).stack;z!==void 0&&(this.stack=this.toString()+`
`+z.replace(/^Error(:[^\n]*)?\n/,""))});return E.prototype=Object.create(l.prototype),E.prototype.constructor=E,E.prototype.toString=function(){return this.message===void 0?this.name:`${this.name}: ${this.message}`},E},Xt,Nn=l=>{var f=So(l),E=le(f);return Bn(f),E},Ot=(l,f)=>{var E=[],C={};function z(Y){if(!C[Y]&&!Ve[Y]){if(he[Y]){he[Y].forEach(z);return}E.push(Y),C[Y]=!0}}throw f.forEach(z),new Xt(`${l}: `+E.map(Nn).join([", "]))};function li(l,f,E,C,z,Y,ae,J,fe,de,Se,We,ut){l>>>=0,f>>>=0,E>>>=0,C>>>=0,z>>>=0,Y>>>=0,ae>>>=0,J>>>=0,fe>>>=0,de>>>=0,Se>>>=0,We>>>=0,ut>>>=0,Se=le(Se),Y=Ze(z,Y),J&&=Ze(ae,J),de&&=Ze(fe,de),ut=Ze(We,ut);var It=G(Se);B(It,function(){Ot(`Cannot construct ${Se} due to unbound types`,[C])}),Le([l,f,E],C?[C]:[],Ct=>{Ct=Ct[0];var pn,mn;C?(pn=Ct.registeredClass,mn=pn.instancePrototype):mn=Ai.prototype;var U=Zn(Se,function(...Lt){if(Object.getPrototypeOf(this)!==W)throw new ye("Use 'new' to construct "+Se);if(re.constructor_body===void 0)throw new ye(Se+" has no accessible constructor");var rn=re.constructor_body[Lt.length];if(rn===void 0)throw new ye(`Tried to invoke ctor of ${Se} with invalid number of parameters (${Lt.length}) - expected (${Object.keys(re.constructor_body).toString()}) parameters instead!`);return rn.apply(this,Lt)}),W=Object.create(mn,{constructor:{value:U}});U.prototype=W;var re=new xe(Se,U,W,ut,pn,Y,J,de);re.baseClass&&(re.baseClass.__derivedClasses??=[],re.baseClass.__derivedClasses.push(re));var pe=new Be(Se,re,!0,!1,!1),Xe=new Be(Se+"*",re,!1,!1,!1),yt=new Be(Se+" const*",re,!1,!0,!1);return er[l]={pointerType:Xe,constPointerType:yt},Ke(It,U),[pe,Xe,yt]})}var gt=(l,f)=>{for(var E=[],C=0;C<l;C++)E.push(H[f+C*4>>>2>>>0]);return E};function Ht(l){for(var f=1;f<l.length;++f)if(l[f]!==null&&l[f].destructorFunction===void 0)return!0;return!1}function jt(l,f){if(!(l instanceof Function))throw new TypeError(`new_ called with constructor type ${typeof l} which is not a function`);var E=Zn(l.name||"unknownFunctionName",function(){});E.prototype=l.prototype;var C=new E,z=l.apply(C,f);return z instanceof Object?z:C}function kt(l,f,E,C){for(var z=Ht(l),Y=l.length,ae="",J="",fe=0;fe<Y-2;++fe)ae+=(fe!==0?", ":"")+"arg"+fe,J+=(fe!==0?", ":"")+"arg"+fe+"Wired";var de=`
        return function (${ae}) {
...
`,We.push("argType"+fe);if(f&&(J="thisWired"+(J.length>0?", ":"")+J),de+=(E||C?"var rv = ":"")+"invoker(fn"+(J.length>0?", ":"")+J+`);
