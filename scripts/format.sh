...
npx prettier --write --ignore-unknown bindings/wasm/*.{js,ts} bindings/wasm/lib/*.ts bindings/wasm/examples/*/*.{js,ts,html} bindings/wasm/test/*.ts bindings/wasm/test/fixtures/*.{ts,mjs} bindings/wasm/types/*.ts &
